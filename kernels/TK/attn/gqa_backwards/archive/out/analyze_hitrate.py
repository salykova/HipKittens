...
# interesting = pivot[pivot['Kernel_Name'].str.contains('attn_bwd_combined_globals')]
interesting = pivot[pivot['Kernel_Name'].str.contains('fmha_bwd_hd128_bf16_a16_rtne')]
