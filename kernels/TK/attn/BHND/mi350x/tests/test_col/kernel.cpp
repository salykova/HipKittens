...
void micro_tk(const micro_globals g) {
    rt<float, BLOCK_SIZE_ROWS, BLOCK_SIZE_COLS, col_l> tile;
    typename rt<float, BLOCK_SIZE_ROWS, BLOCK_SIZE_COLS, col_l>::col_vec norm_vec;
    ...
    mul(tile, tile, scale_factor);

    row_sum(norm_vec, tile);

    sub_row(tile, tile, norm_vec);
    exp(tile, tile);
